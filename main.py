...
for i in cel:
    ...
    try:
        for j in mensaje:
            ...
            input_xpath = '//*[@id="main"]/footer/div[1]/div/span[2]/div/div[2]/div[1]/div/div/p/span'
        ...
        if rutaDocumento:
            for k in rutaDocumento:
                ...
                doc_box = WebDriverWait(driver,20).until(lambda driver: driver.find_element("xpath",doc_box_xpath))
                doc_box.send_keys(k)
                time.sleep(4)
                send_button = WebDriverWait(driver,40).until(lambda driver: driver.find_element("xpath",'//*[@id="app"]/div[1]/div[1]/div[2]/div[2]/span/div[1]/span/div[1]/div/div[2]/div/div[2]/div[2]/div/div/span'))
                send_button.click()
